...
#define MW_CMAKECONFIG px4_fmu-v5_default
...
#define MW_EXTSERIALPORT 4
#define MW_EXTMODESERIALPORT_CHECKBOX 0
#define MW_EXTMODEHOSTCOMPORT /dev/ttyUSB0
...
#define MW_PWM_CH8_FAILSAFE 1520
#define MW_PWM_CH8_DISARMED 1520
